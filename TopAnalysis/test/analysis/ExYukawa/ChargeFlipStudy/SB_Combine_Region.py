...
###############
  ...
  c.Update()
  if Covariance:
    c.SaveAs(plotdir+h+'_CFRate_SB_combine_Cov.png') # Can change the file name
  else:
    c.SaveAs(plotdir+h+'_CFRate_SB_combine_woCov.png')
...
c.Update()
if Covariance:
  c.SaveAs(plotdir+'CFRate_SF_SB_combine_Cov.png') # Can chage the file name
else:
  c.SaveAs(plotdir+'CFRate_SF_SB_combine_woCov.png')
